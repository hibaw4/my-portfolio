const projects = [
  ...
  },
  {
    ...
    demo: '#',
    screenshots: [
      '/screenshots/ourbusway/pagedaccueil1.png',
      '/screenshots/ourbusway/signuppage1.png',
      '/screenshots/ourbusway/signinpage.png',
      '/screenshots/ourbusway/routes.png',
      '/screenshots/ourbusway/ticketpage.png',
      '/screenshots/ourbusway/subscriptionpay.png',
      '/screenshots/ourbusway/subscriptionpayment.png',
      '/screenshots/ourbusway/drivervalidateticket.png',
      '/screenshots/ourbusway/controllerticketvalidation.png',
      '/screenshots/ourbusway/adminusers.png',
    ],
    details: [
  ...
  },
  {
    ...
    demo: '#',
    screenshots: [
      '/screenshots/aws-migration-devsecops/initialarchitecture.jpg',
      '/screenshots/aws-migration-devsecops/proposedarchitecture.jpg',
      '/screenshots/aws-migration-devsecops/pipeline.jpg'
    ],
    details: [
  ...
  },
  {
    ...
    demo: '#',
    screenshots: [
      '/screenshots/traveladvisor360/pagedaccueil.jpg',
      '/screenshots/traveladvisor360/signupsigninpage.jpg',
      '/screenshots/traveladvisor360/homepage1.jpg',
      '/screenshots/traveladvisor360/etapesplanificationvoyage.jpg',
      '/screenshots/traveladvisor360/itineraire.jpg',
      '/screenshots/traveladvisor360/airecommendation.jpg',
      '/screenshots/traveladvisor360/chatbot.jpg',
      '/screenshots/traveladvisor360/experience.jpg',
      '/screenshots/traveladvisor360/profile.jpg',
    ],
    details: [
  ...
  },
  {
    ...
    screenshots: [
      ...
      '/screenshots/space-gateway/spacegateway4.jpg',
      '/screenshots/space-gateway/spacegateway5.jpg',
      '/screenshots/space-gateway/spacegateway6.jpg',
      '/screenshots/space-gateway/spacegateway7.jpg',
      '/screenshots/space-gateway/spacegateway8.jpg',
    ],
    details: [
  ...
  
  {
    ...
    demo: '#',
    screenshots: [
      '/screenshots/cosmetic-property-compatibility/comparaisonmodeles.png',
      '/screenshots/cosmetic-property-compatibility/interfacedelutilisateur.png'
    ],
    details: [
...

  {
    ...
    screenshots: [
      ...
      '/screenshots/internship-management-system/pageinscription2.png',
      '/screenshots/internship-management-system/pageconnexion.png',
      '/screenshots/internship-management-system/pageetudiant.png',
      '/screenshots/internship-management-system/pagecv.png',
      '/screenshots/internship-management-system/pageentreprise.png',
      '/screenshots/internship-management-system/pagegestecole.png',
      '/screenshots/internship-management-system/pagegeststage.png',
      '/screenshots/internship-management-system/pagerespoentretien.png',
      '/screenshots/internship-management-system/pagetuteur.png',
    ],
    details: [
